...
namespace DTcms.DAL.MySql
{
    ...
    public partial class article_attach
    {
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(MySqlConnection conn, MySqlTransaction trans, List<Model.article_attach> models, int channel_id, int article_id)
        {
            if (models != null)
            {
        ...
        /// 更新一条数据
        /// </summary>
        public void Update(MySqlConnection conn, MySqlTransaction trans, List<Model.article_attach> models, int channel_id, int article_id)
        {
            //删除已移除的附件
